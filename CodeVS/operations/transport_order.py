...
def travel_appointment_import(solution, order, lookup_schedule_results, lookup_tugboat_results, appointment_infos, order_trip):
    ...
    for tugboat_id, result in lookup_schedule_results.items():
        ...
        trave_steps = generate_travel_steps(order.order_id, tugboat.tugboat_id, last_point.exit_datetime, last_point.travel_info, order_trip, barge_ids,
                                            extra=" Empty Barges")
    ...
    for tugboat_id, appoint_info in appointment_infos.items():
       ...
       #print()
        ...
        release_steps = generate_release_steps(order.order_id, tugboat.tugboat_id, release_barges_location.enter_datetime, order_trip,
    ...
    for tugboat_id, appoint_info in appointment_infos.items():
       ...
       #print()
        ...
        release_steps = generate_release_steps(order.order_id, tugboat.tugboat_id, 
                                               release_barges_location.enter_datetime, order_trip, barge_ids, appointment_station.station_id)
...
def generate_travel_steps_for_barge_collection(order_id, tugboat_id, arrival_datetime, barge_collection_info, order_trip, barge_ids=[]):
    trave_steps = []
...
def generate_travel_steps(order_id, tugboat_id, arrival_datetime, travel_info, order_trip, barge_ids=[], extra=""):
    trave_steps = []
    start_travel_time = arrival_datetime
    # print(travel_info['steps'][0]['start_id'])
    # print(travel_info['steps'][-1]['end_id'])
...
def generate_release_steps(order_id, tugboat_id, arrival_datetime, order_trip, barge_ids, station_id):
    trave_steps = []
    start_travel_time = arrival_datetime
...
def travel_trought_sea_export_to_customer(order, lookup_sea_tugboat_results, order_trip):
    ...
    for tugboat_id, tugboat_result in lookup_sea_tugboat_results.items():
        ...
        travel_steps = generate_travel_steps(order.order_id, tugboat.tugboat_id, arrival_datetime, travel_info, order_trip, barge_ids, extra=" Load Barges")
        tugboat_result['data_points'].extend(travel_steps)
